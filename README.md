...
- [Plugins](#plugins-) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->186<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->186<!--/plugin_count-->** plugins listed.
...
- [API List All](https://github.com/rosano/yourls-api-action-list) - Add an "list" action to the API to show all keywords.
