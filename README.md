...
- [Conditional URLAds (GUI)](https://github.com/8Mi-Tech/yourls-conditional-urlads) - A plugin that forks [Conditional URLAds](https://github.com/HeroCC/yourls-conditional-urlads), but it's more elegant and convenient in terms of setting parameters, For example, directly within a WebPage
