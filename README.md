...
- [Drupal alt](https://www.drupal.org/project/shorten) : A more robust solution. Requires [this](https://github.com/joshp23/YOURLS-title-refetch) (title-refetch) and [this](https://bitbucket.org/laceous/yourls-concurrency-fix) (API Concurrency Fix) in YOURLS. See [this](https://www.drupal.org/project/shorten/issues/2889342) issue.
