...
- [Plugins](#plugins) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->220<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->220<!--/plugin_count-->** plugins listed.
...
- [Allow Hyphens in Short URLs](https://github.com/k1nsej/YOURLS-Hyphens-In-Urls) - This plugin will allow hyphens `-` in keywords when shortening URLs.
