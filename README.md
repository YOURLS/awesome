...
- [Plugins](#plugins) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->261<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->261<!--/plugin_count-->** plugins listed.
...
- [Blacklist Domains](https://github.com/AlkalineJaunt/YourlsBlacklistDomains) - A simple plugin to blacklist domains from shortening URLs.
- [Better Blacklist Domains](https://git.satki.net/Sophia/better-yourls-blacklist-domains) - A better plugin to blacklist domains from shortening URLs.
...
- [Frontend Links](https://github.com/sangcent/yourls.frontend-links) - Link-in-bio page served directly by YOURLS. Manage sections, links, profile and custom icons from the admin panel. Includes branded redirect interstitial with OG metadata, custom 404 page, and full subdirectory support.
...
- [Notes](https://github.com/pedrazadixon/yourls-notes) - Create and share text or Markdown notes as short URLs, with inline editing, search integration, and click tracking.
...
- [YOURLS-TN](https://github.com/sgiovagnoli/YOURLS-TN) - Display thumbnails on YOURLS admin page and stats page, using thumbnail.ws.
...
- [Shorrrrrten](https://github.com/Codeinwp/shorrrrrten) - A simple React based frontend for YOURLS.
...
- [Ukrainian](https://github.com/pekarskyi/YOURLS-uk) (`uk`)
...
- Laravel
  ...
  - [Laravel YOURLS](https://github.com/danielmrdev/laravel-yourls)
...
- iOS
  - [ShortTail](https://www.adamdehaven.com/articles/shorttail-for-yourls-an-elegant-yourls-client-for-iphone) - An elegant YOURLS client for iPhone.
...
- Chrome
  - [YOURLS](https://chromewebstore.google.com/detail/yourls/nddaaiojgkoldnhnmkoldmkeocbooken)
- Firefox
...
- Windows
  - [YOURLS Clipboard Shortener](https://github.com/Bluscream/yourls-tray-app/releases/latest) - System tray app to automatically shorten clipboard links for Windows and Linux (x11/Wayland).
  - [YOURLS on Windows](https://appsonwindows.com/apk/127308/) - Run YOURLS as a Windows program.
- Linux
  - [YOURLS Clipboard Shortener](https://github.com/Bluscream/yourls-tray-app/releases/tag/v1.0.0) - System tray app to automatically shorten clipboard links for Windows and Linux (x11/Wayland).
