...
- [Plugins](#plugins) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->201<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->201<!--/plugin_count-->** plugins listed.
...
- Simplified Chinese (`zh_CN`)  [1.9.1](https://github.com/taozhiyu/yourls-translation-zh_CN) (history: [1.7.3](https://github.com/ZvonimirSun/YOURLS-zh_CN))
