...
- [Plugins](#plugins) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->215<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->215<!--/plugin_count-->** plugins listed.
