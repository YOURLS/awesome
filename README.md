...
- [Integration](#integration) - Third-party integrations and frameworks
...
- [Fallback URL](https://github.com/ozh/yourls-fallback-url/)☑️ - Redirect to a custom URL when the short URL does not exist
