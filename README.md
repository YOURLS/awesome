...
- [Plugins](#plugins) - what makes YOURLS so versatile and powerful.
  Currently: **<!--plugin_count-->231<!--/plugin_count-->** plugins listed.<!-- DO NOT UPDATE THIS COUNT MANUALLY -->
...
Currently we have **<!--plugin_count-->231<!--/plugin_count-->** plugins listed.
...
- [Unghoster](https://github.com/thefrosty/yourls-unghoster) - Adds Unghoster script before redirecting - Helps identify people visiting your website in real time, transforming anonymous traffic into valuable sales leads.
